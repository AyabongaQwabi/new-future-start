import { XCircle, RefreshCw, Phone, Mail, ArrowLeft, CreditCard, Wifi, AlertTriangle } from "lucide-react"
...
async function updateFailedOrder(orderId: string) {
  try {
    const response = await fetch(`${process.env.NEXT_PUBLIC_SITE_URL || "http://localhost:3000"}/api/checkout/failed`, {
      method: "POST",
      headers: {
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              Don't worry! No charges were made to your account. Let's get this sorted out.
            </p>
          </div>
          ...
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>Here are some quick fixes you can try:</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg">
                  ...
                  <div>
                    <h4 className="font-medium text-green-900">Connection Issues</h4>
                ...
                <div className="flex items-start gap-3 p-3 bg-purple-50 rounded-lg">
                  ...
                  <div>
                    <h4 className="font-medium text-purple-900">Bank Security</h4>
          ...
          <Card className="bg-gradient-to-r from-purple-50 to-pink-50">
            <CardHeader>
              ...
              <CardDescription>Our support team is ready to assist you with your purchase.</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <Button variant="outline" className="h-auto p-4 bg-transparent" asChild>
                  <a href="https://wa.me/27720419723" target="_blank" rel="noopener noreferrer">
                    <div className="text-center">
                      ...
                      <div className="text-xs text-gray-500 mt-1">Quick response guaranteed</div>
                    </div>
                  </a>
                </Button>
              </div>
              ...
              <div className="mt-4 p-4 bg-yellow-50 rounded-lg">
                <p className="text-sm text-yellow-800">
                  <strong>💡 Pro Tip:</strong> When contacting support, please mention that your payment failed
                  {orderId && ` and include this reference: ${orderId}`}. This helps us assist you faster!
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="text-center mt-8 p-6 bg-white rounded-lg shadow-sm">
            <h3 className="font-bold text-lg mb-2">Don't Give Up on Your Dreams! 🌟</h3>
            <p className="text-gray-600">
              Thousands of students have already transformed their university experience with our book. A small payment
              hiccup won't stop you from joining them! Let's get this sorted out together.
            </p>
          </div>
        </div>
      </div>
