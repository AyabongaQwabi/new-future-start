      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <Card className="bg-yellow-50 border-yellow-200 max-w-2xl mx-auto">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl text-yellow-800">Service Temporarily Unavailable</CardTitle>
          </CardHeader>
          <CardContent className="text-center space-y-4">
            <p className="text-yellow-700">
              Our order tracking system is currently being set up. Don't worry - your order is safe and being processed!
            </p>
            <div className="space-y-3">
              <p className="text-sm text-yellow-600">In the meantime, you can contact us directly for order updates:</p>
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Button asChild className="bg-yellow-600 hover:bg-yellow-700">
                  <a href="mailto:majork.n07@gmail.com">📧 Email Us</a>
                </Button>
                <Button asChild variant="outline" className="border-yellow-600 text-yellow-600 bg-transparent">
        ...
        <Card className="mt-12 bg-gradient-to-r from-blue-500 to-purple-500 text-white border-0">
          <CardContent className="p-8 text-center">
            ...
            <p className="mb-6 text-blue-100">Our team is here to help with any questions about your order!</p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="outline" className="border-white text-blue-600 hover:bg-white/20 bg-transparent" asChild>
                <a href="mailto:majork.n07@gmail.com">📧 Email Support</a>
              </Button>
              <Button variant="outline" className="border-white text-blue-600 hover:bg-white/20 bg-transparent" asChild>
                <a href="https://wa.me/27720419723" target="_blank" rel="noopener noreferrer">
                  💬 WhatsApp Us
