  ...
  return (
    <div className='flex min-h-screen flex-col bg-gradient-to-br from-purple-50 via-pink-50 to-yellow-50'>
      ...
      <main className='flex-1'>
          ...
          <div className='container px-4 md:px-6 relative z-10'>
            <div className='max-w-4xl mx-auto text-center'>
              <h1
                ...
                style={{
                  fontFamily:
                    '"Cambria Math", "Angsana New", "Times New Roman", serif',
                }}
              >
                ...
                <div className='bg-white rounded-3xl p-8 shadow-xl border-l-4 border-purple-500'>
                  ...
                  <div className='space-y-4 text-gray-700'>
                    <p className='bg-purple-50 p-4 rounded-2xl border-l-4 border-purple-400'>
                      <strong>🎯 Stressed about uni applications?</strong> We've
                      got your back! We handle the entire application process so
                      you can focus on what matters most - your studies and
                      having fun! 📚✨
                    </p>
                    <p className='bg-pink-50 p-4 rounded-2xl border-l-4 border-pink-400'>
                      <strong>🚀 Want to absolutely crush it at uni?</strong>{' '}
                      Our mentoring programs are like having a super smart older
                      sibling who's been there, done that, and got the cum laude
                      to prove it! Based on our bestselling book by a top
                      academic achiever 📖🏆
                    </p>
                    <p className='bg-blue-50 p-4 rounded-2xl border-l-4 border-blue-400'>
                      <strong>🏠 Need a place to crash near campus?</strong>{' '}
                      We'll hook you up with safe, affordable accommodation that
                      doesn't suck. No more living in your car or that sketchy
                      place your cousin found! 🛏️🔑
                    </p>
                  </div>
                ...
                <div className='flex items-start gap-3'>
                  ...
                  <div>
                    ...
                    <p className='text-pink-100 text-sm'>
                      Techniques that actually work (not just theory)
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section
          id='services'
          className='w-full py-12 md:py-24 lg:py-32 bg-gradient-to-br from-gray-50 to-purple-50'
        >
          <div className='container px-4 md:px-6'>
            <div className='text-center mb-12'>
              ...
              <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
                Everything you need to absolutely crush your uni journey - from
                getting in to graduating with honors! 🚀
              </p>
            </div>
            ...
            <div className='grid gap-8 md:grid-cols-3'>
              <Card className='bg-white rounded-3xl shadow-xl border-0 overflow-hidden hover:shadow-2xl transform hover:scale-105 transition-all duration-300'>
                ...
                <CardContent className='p-6'>
                  <p className='text-gray-600 mb-6'>
                    Chill while we handle all the boring paperwork! ✨ From
                    finding the perfect uni to submitting everything on time -
                    we've got this! 🎯
                  </p>
                  <Button
              ...
              <Card className='bg-white rounded-3xl shadow-xl border-0 overflow-hidden hover:shadow-2xl transform hover:scale-105 transition-all duration-300'>
                ...
                <CardContent className='p-6'>
                  <p className='text-gray-600 mb-6'>
                    Get that big sibling energy! 💪 Our mentors are like having
                    a cheat code for uni success - they've been there and
                    crushed it! 🏆
                  </p>
                  <Button
              ...
              <Card className='bg-white rounded-3xl shadow-xl border-0 overflow-hidden hover:shadow-2xl transform hover:scale-105 transition-all duration-300'>
                ...
                <CardContent className='p-6'>
                  <p className='text-gray-600 mb-6'>
                    No more sketchy places! 🙅‍♀️ We'll find you a safe, affordable
                    spot that's actually cool to live in near your campus! 🔑
                  </p>
                  <Button
          ...
          <div className='container px-4 md:px-6 relative z-10'>
            <div className='text-center text-white'>
              <h2 className='text-3xl md:text-5xl font-black mb-4'>
                Don't Go Through Uni Alone! 🤝
              </h2>
              <p className='text-xl md:text-2xl mb-8 text-white/90'>
                Join thousands of students who are absolutely crushing it with
                our help! 🚀✨
              </p>
        ...
        >
          <div className='container px-4 md:px-6'>
            <div className='text-center mb-12'>
              ...
              <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
                Real students, real results, real talk! 💯 Check out what your
                future classmates are saying about us! 🎓
              </p>
            </div>
        ...
        >
          <div className='container px-4 md:px-6'>
            <div className='text-center mb-12'>
              ...
              <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
                The ultimate cheat sheet for crushing uni life! Written by
                someone who actually did it and got the cum laude to prove it!
                🏆✨
              </p>
            </div>
      ...
      <footer className='w-full bg-gray-900 text-white py-8'>
        <div className='container flex flex-col items-center justify-between gap-4 md:flex-row'>
          <p className='text-center text-sm text-gray-400'>
            © 2025 Future Start. Made with 💜 for students who want to win at
            life!
          </p>
